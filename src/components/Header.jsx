...
function Header() {
  ...
  return (
    ...
    <nav className='fixed bg-black flex align-middle justify-between py-0 px-12 w-full z-50 h-16'>
        <div className='flex flex-row items-center text-centerfont-normal uppercase text-white'>
        ...
        <article className='flex items-center font-semibold text-center text-white mx-3'>
